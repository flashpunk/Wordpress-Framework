...
function pagenavi($before = '<div class="twelve columns">', $after = '</div>') {
    ...
    if (!is_single()) {
        ...
        if($max_page > 1 || intval($pagenavi_options['always_show']) == 1) {
            ...
            if(!empty($pages_text)) {
                echo '<li class="unavailable"><span class="pages">'.$pages_text.'</span></li>';
            }
            ...
            if ($start_page >= 2 && $pages_to_show < $max_page) {
                ...
                if(!empty($pagenavi_options['dotleft_text'])) {
                    echo '<li class="unavailable">'.$pagenavi_options['dotleft_text'].'</li>';
                }
            }
